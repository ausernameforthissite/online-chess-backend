...
public class CommonTextConstants {
    public static final String NO_MATCH = "Матч с id=%d не найден.";
    public static final String NO_ACTIVE_MATCH = "Матч с id=%d не существует или уже завершён.";
    public static final String ALREADY_SEARCHING = "Вы уже ищите игру (возможно, из другой вкладки или с другого устройства).";
    public static final String ALREADY_IN_MATCH = "Вы уже в игре. matchId=%d";
    ...
    public static final String MATCH_ID_NOT_FOUND = "No rating record was found for match with matchId: %d";
    public static final String INCORRECT_MATCH_ID = "Incorrect matchId!";
